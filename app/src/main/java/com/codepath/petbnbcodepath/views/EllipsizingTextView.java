package com.codepath.petbnbcodepath.views;
...
/*
 * Obtained from https://github.com/IPL/MultiplelineEllipsizeTextView
 * to support middle ellipsizing with multiple lines. Currently, middle ellipses works only with
 * single line
 */
